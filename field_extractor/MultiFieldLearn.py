...
#    print >>fout, "number of rules before validation = ", len(rules)
#    for r in rules:
#        print >>fout, r.getPattern() 
...
def _generateRules(fromField, markedEvents, filterstring):
    ...
    for markedEvent in markedEvents:
        #myId = markedEvent['id']
        #print markedEvent, type(markedEvent)
...
#    if not check_test_results(expect,receive):
    if len(receive) == 0:
        ...
        print "test_filter passed: rule = ", receive[0]
